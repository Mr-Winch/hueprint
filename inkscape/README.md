...
HuePrint 1.1.2 is a visual color-harmony studio for Inkscape 1.4 or newer. It includes the interactive color donut, harmony geometry, all 53 HuePrint palette recipes, saved colors, JSON/GPL import, and Inkscape-compatible GPL export.
...
7. Open **Extensions → Color → HuePrint © 1.1.2**.
...
6. Open **Extensions → Color → HuePrint © 1.1.2**.
...
2. Open **Extensions → Color → HuePrint © 1.1.2**.
