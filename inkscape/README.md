...
HuePrint 1.1.1 is a visual color-harmony studio for Inkscape 1.4 or newer. It includes the interactive color donut, harmony geometry, all 53 HuePrint palette recipes, saved colors, and JSON import/export.
...
7. Open **Extensions → Color → HuePrint © 1.1.1**.
...
6. Open **Extensions → Color → HuePrint © 1.1.1**.
...
2. Open **Extensions → Color → HuePrint © 1.1.1**.
