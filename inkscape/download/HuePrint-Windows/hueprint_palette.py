...
def palette_storage_path(environ=None, home=None, platform=None):
    """Return HuePrint's data file without writing to Inkscape's config directory."""
    ...
    return base / "HuePrint" / "saved-palettes.json"
